...
- [✨ Tailwind CSS v4.0 is here! Huge performance improvements, radically simplified setup experience, CSS-first configuration, modernized P3 color palette, container queries, 3D transforms, expanded gradient APIs, @​starting-style support… …and tons, tons more. pic.twitter.com/zBSfm6IOf7](https://x.com/adamwathan/status/1882219476600635677)
<!-- TWITTER:END -->
