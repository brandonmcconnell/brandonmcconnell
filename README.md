...
- [@branmcconnell: CSS scrolling question 📜🙋🏻‍♂️ I&#39;m using `scroll-behavior: smooth;` for all links on my sites, but when deep linking to an in-page ID from another site, I&#39;d like the page to load/jump to the specified ID w/o smooth scrolling. I tried `@‍starting-style { scroll-behavior: auto; }` but it didn&#39;t work. Is there a better &amp; working solution to this? `@‍starting-style` seemed fitting in nature for this sort of behavior. #CSS #CSSWG](https://twitter.com/branmcconnell/status/1803842451477495909)
<!-- TWITTER:END -->
